...
y.lab="Reproducibility rank" #Name of factor you are looking at
testcollumn<- All.Factors.Diff$`Aggregated Reproducibility Rank` #get the collumn of factor you want to look at
...
ggplot(All.Factors.Diff, aes(x=Three.Protein.Gain, y=testcollumn, fill=Three.Protein.Gain))+
  ...
  ylab(y.lab)
# 5x4
# plot.mean.factor.Gain.boxplot.Reproducibility
...
ggplot(All.Factors.Diff, aes(x=Three.Protein.Loss, y=testcollumn, fill=Three.Protein.Loss))+
  ...
  ylab(y.lab)
# 5x4
# plot.mean.factor.Loss.boxplot.Reproducibility
...
##### Random Permutation test to add significance to Buffering Factors #####
# 210908
